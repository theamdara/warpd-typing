...
#define set_name(keyname) \
	...
	break;
			...
			case 48: set_name("tab")
			case 122: set_name("f1")
			case 120: set_name("f2")
			case 99: set_name("f3")
			case 118: set_name("f4")
			case 96: set_name("f5")
			case 97: set_name("f6")
			case 98: set_name("f7")
			case 100: set_name("f8")
			case 101: set_name("f9")
			case 109: set_name("f10")
			case 103: set_name("f11")
			case 111: set_name("f12")
#undef set_name
		}
